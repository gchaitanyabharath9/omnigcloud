...
% Word Count: 3716
% Threshold: 5000
% STATUS: FAIL_LENGTH (Needs ~1284 more words)
% PUBLICATION_READINESS_GATE
% Word Count: 3704
% Threshold: 5000
% STATUS: FAIL_LENGTH (Needs ~1296 more words)
% PUBLICATION_READINESS_GATE
% Word Count: 3692
% Threshold: 5000
% STATUS: FAIL_LENGTH (Needs ~1308 more words)
% PUBLICATION_READINESS_GATE
% Word Count: 3680
% Threshold: 5000
% STATUS: FAIL_LENGTH (Needs ~1320 more words)
...
identity = {"provider": "aws", "user": user, "role": role} {
    ...
    regex.match("arn:aws:iam::._:role/(._)", input.identity.arn)
...
% LENGTH GATE WARNING: Short by ~299 words.
