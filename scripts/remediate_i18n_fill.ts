...
const DYNAMIC_KEYS = [
    ...
    // Steps usually 0-2
    'SEO_Content.Home.HowItWorks.steps.0.title', 'SEO_Content.Home.HowItWorks.steps.0.desc',
    'SEO_Content.Home.HowItWorks.steps.1.title', 'SEO_Content.Home.HowItWorks.steps.1.desc',
    'SEO_Content.Home.HowItWorks.steps.2.title', 'SEO_Content.Home.HowItWorks.steps.2.desc',

    'SEO_Content.Home.DeepDive.title', 'SEO_Content.Home.DeepDive.content',
    'SEO_Content.Home.LeadCapture.title', 'SEO_Content.Home.LeadCapture.subtitle', 'SEO_Content.Home.LeadCapture.cta',
    'SEO_Content.Home.TechnicalApproach.title', 'SEO_Content.Home.TechnicalApproach.content',
    'SEO_Content.Home.WhyItMatters.title', 'SEO_Content.Home.WhyItMatters.content',

    // Cookie
    'CookieConsent.title', 'CookieConsent.message', 'CookieConsent.policyLink', 'CookieConsent.accept', 'CookieConsent.decline', 'CookieConsent.sovereignNotice'
];
...
function generateText(key: string): string {
    ...
    if (last === 'desc' || last === 'description' || last === 'content') return `Comprehensive content for ${humanize(parent)}.`;
