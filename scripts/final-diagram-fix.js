...
const absoluteOutput = path.join(workspaceRoot, `publication-pdfs/A1_Strict_Sanitized_${timestamp}.pdf`);
const sanitizedMdPath = path.join(workspaceRoot, `publication-pdfs/A1_Sanitized_TEST_${timestamp}.md`);
    ...
    try {
        await mdToPdf({ content: template }, {
            ...
            pdf_options: {
                ...
                headerTemplate: '<div style="font-size: 8px; margin-left: 20px;">A1 Reference Architecture - Final Render</div>',
