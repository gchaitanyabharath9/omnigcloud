...
const papers = [
  ...
  },
  {
    ...
    output: "A5-Monolith-Modernization.pdf",
  },
  {
      ...
      if (l.startsWith("subgraph")) {
        ...
        if (parts.length > 2) {
          ...
          const label = parts
            .slice(2)
            .join(" ")
            .replace(/[^\w\s\:]/g, ""); // strip complex chars
          l = `subgraph ${id} ["${label}"]`;
        }
      }
    }
      ...
      await mdToPdf(
        { content: template },
        {
          ...
          pdf_options: {
            ...
            footerTemplate:
              '<div style="font-size: 8px; text-align: center; width: 100%; color: #999;">Page <span class="pageNumber"></span> of <span class="totalPages"></span></div>',
          },
          launch_options: {
