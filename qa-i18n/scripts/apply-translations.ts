  ...
  es: {
    Docs: {
      meta: {
        ...
        description:
          "Documentación de arquitectura agnóstica de nube basada en evidencia. Lea el libro blanco académico y explore los patrones de orquestación autónoma.",
      },
      hero: {
        title: "Compendio Técnico Erudito",
        badge: "CONTRIBUCIÓN ORIGINAL DE GRAN SIGNIFICADO",
        description:
          "La siguiente documentación formaliza el marco de Orquestación Soberana Autónoma (ASO). Este compendio sirve como la evidencia técnica primaria para la revisión académica, demostrando un avance significativo en el gobierno agnóstico de la nube y la sincronización de estado de múltiples infraestructuras.",
      },
      sidebar: {
      ...
      banner: {
        ...
        description:
          "Planos de cumplimiento preconfigurados para SOC 2, HIPAA y GDPR con remediación de desviación automática.",
        cta: "Explorar Planos",
      },
    },
  },
  fr: {
    Docs: {
      meta: {
        ...
        description:
          "Documentation d'architecture cloud-agnostique basée sur des preuves. Lisez le livre blanc académique et explorez les modèles d'orchestration autonome.",
      },
      hero: {
        title: "Compendium Technique Savant",
        badge: "CONTRIBUTION ORIGINALE DE GRANDE IMPORTANCE",
        description:
          "La documentation suivante formalise le cadre d'Orchestration Souveraine Autonome (ASO). Ce compendium sert de preuve technique primaire pour l'examen académique, démontrant une percée significative dans la gouvernance cloud-agnostique et la synchronisation d'état multi-infrastructure.",
      },
      sidebar: {
      ...
      banner: {
        ...
        description:
          "Modèles de conformité pré-configurés pour SOC 2, HIPAA et GDPR avec remédiation automatique de la dérive.",
  ...
  de: {
    Docs: {
      meta: {
        ...
        description:
          "Evidenzbasierte cloud-agnostische Architektur-Dokumentation. Lesen Sie das wissenschaftliche Whitepaper und erkunden Sie autonome Orchestrierungsmuster.",
      },
      hero: {
      ...
      banner: {
        ...
        description:
          "Vorkonfigurierte Compliance-Blueprints für SOC 2, HIPAA und GDPR mit automatischer Drift-Korrektur.",
  ...
  zh: {
    Docs: {
      ...
      hero: {
        ...
        badge: "具有重大意义的原创性贡献",
        description:
          "以下文档正式确定了自主主权编排 (ASO) 框架。本纲要作为学术评审的主要技术依据，展示了在云原生治理和多基础设施状态同步方面的重大突破。",
      },
      sidebar: {
        documentation: "文档",
        links: {
  ...
  hi: {
    Docs: {
      meta: {
        ...
        description:
          "साक्ष्य-आधारित क्लाउड-अज्ञेयवादी आर्किटेक्चर दस्तावेज़। विद्वतापूर्ण श्वेतपत्र पढ़ें और स्वायत्त ऑर्केस्ट्रेशन पैटर्न का पता लगाएं।",
      },
      hero: {
        title: "विद्वतापूर्ण तकनीकी सारांश",
        badge: "प्रमुख महत्व का मूल योगदान",
        description:
          "निम्नलिखित दस्तावेज़ स्वायत्त संप्रभु ऑर्केस्ट्रेशन (ASO) ढांचे को औपचारिक रूप देता है। यह सारांश विद्वतापूर्ण समीक्षा के लिए प्राथमिक तकनीकी साक्ष्य के रूप में कार्य करता है, जो क्लाउड-अज्ञेयवादी शासन और बहु-बुनियादी ढांचे की स्थिति सिंक्रनाइज़ेशन में एक महत्वपूर्ण सफलता का प्रदर्शन करता है।",
      },
      sidebar: {
      ...
      banner: {
        ...
        description:
          "स्वचालित बहाव निवारण के साथ SOC 2, HIPAA और GDPR के लिए पूर्व-कॉन्फ़िगर अनुपालन ब्लूप्रिंट।",
  ...
  ja: {
    Docs: {
      meta: {
        ...
        description:
          "証拠に基づいたクラウド・アグノスティック・アーキテクチャ・ドキュメント。学術ホワイトペーパーを読み、自律的なオーケストレーション・パターンを探索してください。",
      },
      hero: {
        title: "学術技術要覧",
        badge: "重大な意義を持つ独創的な貢献",
        description:
          "以下のドキュメントは、自律主権オーケストレーション (ASO) フレームワークを形式化したものです。この要覧は、学術的な審査のための主要な技術的証拠として機能し、クラウド・アグノスティックなガバナンスと複数インフラストラクチャの状態同期における画期的な進歩を実証しています。",
      },
      sidebar: {
      ...
      banner: {
        title: "ガバナンス・ブループリント",
        description:
          "自動的なドリフト修正を備えた、SOC 2、HIPAA、GDPR向けの事前設定済みコンプライアンス・ブループリント。",
        cta: "ブループリントを探索",
      },
    },
  },
  ko: {
    Docs: {
      meta: {
        ...
        description:
          "증거 기반의 클라우드 애그노스틱 아키텍처 문서. 학술 백서를 읽고 자율 오케스트레이션 패턴을 살펴보세요.",
      },
      hero: {
        title: "학술 기술 개요",
        badge: "중대한 의미를 지닌 독창적 공헌",
        description:
          "다음 문서는 자율 주권 오케스트레이션(ASO) 프레임워크를 공식화합니다. 이 개요는 학술적 검토를 위한 주요 기술적 증거로 활용되며, 클라우드 애그노스틱 거버넌스 및 다중 인프라 상태 동기화의 획기적인 발전을 입증합니다.",
      },
      sidebar: {
        documentation: "문서",
        links: {
      ...
      banner: {
        title: "거버넌스 청사진",
        description:
          "자동 드리프트 해결 기능을 갖춘 SOC 2, HIPAA 및 GDPR을 위한 사전 구성된 준수 청사진.",
        cta: "청사진 살펴보기",
      },
    },
  },
