...
% Generated: 2026-01-16T19:10:01.122Z
...
\subsubsection{Relationship to A1-REF-STD Architectural Invariants}\label{relationship-to-a1-ref-std-architectural-invariants}
...
1. Sustained \textgreater80\% partition utilization for 7 days
2. Projected growth exceeds capacity within 30 days
3. Hot spot detected (one partition \textgreater2x average load)
