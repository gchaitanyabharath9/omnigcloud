...
export default function PartnersPage() {
    ...
    const cloudPartners = [
        { name: t("hyperscale.aws.name"), level: t("hyperscale.aws.level"), img: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&h=250&fit=crop", desc: t("hyperscale.aws.desc") },
        { name: t("hyperscale.azure.name"), level: t("hyperscale.azure.level"), img: "https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=400&h=250&fit=crop", desc: t("hyperscale.azure.desc") },
        { name: t("hyperscale.gcp.name"), level: t("hyperscale.gcp.level"), img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=250&fit=crop", desc: t("hyperscale.gcp.desc") }
    ];

    const ecosystemPartners = [
        { name: "Harness", category: t("ecosystem.categories.cd"), icon: <Layers color="#60efff" size={32} /> },
        { name: "HashiCorp", category: t("ecosystem.categories.infra"), icon: <Server color="#60efff" size={32} /> },
        { name: "Red Hat OpenShift", category: t("ecosystem.categories.platform"), icon: <Globe color="#60efff" size={32} /> },
        { name: "Dynatrace", category: t("ecosystem.categories.observability"), icon: <Cloud color="#60efff" size={32} /> }
    ];
    ...
    return (
        <div className="animate-fade-in">
            ...
            <section className="container section-padding text-center">
                ...
                <h1 className="text-gradient" style={{ fontSize: '3.5rem', marginBottom: '1.5rem' }}>{t("hero.title")}</h1>
            ...
            <section className="container section-padding">
                <h2 style={{ fontSize: '2rem', color: 'white', marginBottom: '3rem', textAlign: 'center' }}>{t("hyperscale.title")}</h2>
            ...
            <section className="bg-dark section-padding" style={{ background: 'rgba(0,0,0,0.2)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                <div className="container">
                    <h2 style={{ fontSize: '2rem', color: 'white', marginBottom: '4rem', textAlign: 'center' }}>{t("ecosystem.title")}</h2>
            ...
            <section className="container section-padding">
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
                    <div>
                        <h2 style={{ fontSize: '2.5rem', color: 'white', marginBottom: '1.5rem' }}>{t("joint.title")}</h2>
                    ...
                    <div className="glass-panel" style={{ padding: '3rem', borderRadius: '2rem', textAlign: 'center' }}>
                        <h3 style={{ color: '#60efff', fontSize: '1.5rem', marginBottom: '1.5rem' }}>{t("joint.cta.title")}</h3>
