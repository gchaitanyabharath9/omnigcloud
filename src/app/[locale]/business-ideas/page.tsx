    ...
    <section className="container section-padding">
      <div className="animate-fade-in">
        <h1
          ...
          style={{ fontSize: "2.5rem", marginBottom: "1.25rem", textAlign: "center" }}
        >
          {t("hero.title")}
        </h1>
        <p
        ...
        >
          ...
          >
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              <h3 style={{ marginTop: "0.75rem", marginBottom: "1rem", fontSize: "1.25rem" }}>
                {t("cards.0.title")}
              </h3>
              ...
              >
                {t("cards.0.link")} <ArrowRight size={16} />
              </Link>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              >
                {t("cards.1.link")} <ArrowRight size={16} />
              </Link>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              >
                {t("cards.2.link")} <ArrowRight size={16} />
              </Link>
            </div>
          </div>
        </div>
