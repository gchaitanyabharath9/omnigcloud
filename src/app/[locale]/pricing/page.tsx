  ...
  return generateSEOMetadata(
    {
      ...
      description: tm.has("description")
        ? tm("description")
        : "Transparent, value-based pricing for your sovereign cloud modernization journey.",
    ...
    <>
          ...
          <div className="grid-4">
            {plans.map((plan, idx) => (
              <div
                key={idx}
                id={plan.id}
                className={`glass-panel ${plan.highlight ? "border-primary pricing-plan-highlight" : ""}`}
                style={{
                  padding: "1.25rem",
              ...
              >
                ...
                <h3 style={{ fontSize: "1rem", fontWeight: 900, marginBottom: "0.2rem" }}>
                  {tSafe(t, `plans.${plan.id}.name`, plan.id.toUpperCase())}
                </h3>
                <p
                  style={{
                    fontSize: "0.7rem",
                ...
                >
                  {tSafe(t, `plans.${plan.id}.desc`, "Empowering your cloud journey.")}
                </p>
      ...
      >
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            <div className="badge badge-primary-subtle mb-3">
              {tSafe(t, "savings.badge", "SAVINGS")}
            </div>
            <h2 style={{ fontSize: "2.5rem", fontWeight: 950, marginBottom: "0.5rem" }}>
              {tSafe(t, "savings.title", "Analyze Your Savings Potential")}
            </h2>
            <p style={{ opacity: 0.7, maxWidth: "700px", margin: "0 auto", fontSize: "0.95rem" }}>
              {tSafe(
                t,
                "savings.subtitle",
                "Our arbitrage engine identifies optimization opportunities in real-time."
              )}
            </p>
          </div>
      ...
      >
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            ...
            <h2 style={{ fontSize: "2.5rem", fontWeight: 950, marginBottom: "1rem" }}>
              {tSafe(t, "economy.title", "Value-Based Infrastructure Economy")}
            </h2>
            <p style={{ opacity: 0.7, maxWidth: "800px", margin: "0 auto", fontSize: "1rem" }}>
              {tSafe(
                t,
                "economy.subtitle",
                "Our autonomous framework ensure absolute sovereignty and compliance."
              )}
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <h3 style={{ fontSize: "1.5rem", fontWeight: 900, marginBottom: "1rem" }}>
                {tSafe(t, "economy.steps.1.title", "Transparent Units")}
              </h3>
              <p style={{ opacity: 0.7, lineHeight: 1.6 }}>
                {tSafe(t, "economy.steps.1.desc", "Pricing based on managed sovereign nodes.")}
              </p>
            </div>
            ...
            >
              ...
              <h3 style={{ fontSize: "1.5rem", fontWeight: 900, marginBottom: "1rem" }}>
                {tSafe(t, "economy.steps.2.title", "Egress Arbitrage")}
              </h3>
              <p style={{ opacity: 0.7, lineHeight: 1.6 }}>
                {tSafe(
                  t,
                  "economy.steps.2.desc",
                  "Automatically identify the most cost-effective compliant route."
                )}
              </p>
            </div>
            ...
            >
              ...
              <h3 style={{ fontSize: "1.5rem", fontWeight: 900, marginBottom: "1rem" }}>
                {tSafe(t, "economy.steps.3.title", "Predictive Burn Rate")}
              </h3>
              <p style={{ opacity: 0.7, lineHeight: 1.6 }}>
                {tSafe(
                  t,
                  "economy.steps.3.desc",
                  "Real-time cost forecasting with high precision."
                )}
              </p>
            </div>
          </div>
          ...
          >
            <h3 style={{ fontSize: "1.8rem", fontWeight: 900, marginBottom: "1rem" }}>
              {tSafe(t, "economy.sovereignty.title", "Economic Sovereignty")}
            </h3>
            <p style={{ opacity: 0.8, lineHeight: 1.7, marginBottom: "1.5rem" }}>
              {tSafe(
                t,
                "economy.sovereignty.desc",
                "Digital sovereignty is impossible without economic sovereignty."
              )}
            </p>

            <div
              className="glass-panel"
              style={{ padding: "1.5rem", borderRadius: "1rem", background: "var(--card-bg)" }}
            >
              <Zap size={32} color="var(--primary)" style={{ marginBottom: "1rem" }} />
              <h4 style={{ fontSize: "1.3rem", fontWeight: 900, marginBottom: "1rem" }}>
                {tSafe(t, "economy.sovereignty.arbitrage.title", "Automated Cost Arbitrage")}
              </h4>
              <p style={{ opacity: 0.7, lineHeight: 1.6 }}>
                {tSafe(
                  t,
                  "economy.sovereignty.arbitrage.desc",
                  "Arbitrage engine continuously scans across pricing APIs."
                )}
              </p>
            </div>
          </div>
      ...
      >
        <div className="container">
          <div style={{ marginBottom: "2rem" }}>
            <h2 style={{ fontSize: "2.5rem", fontWeight: 950, marginBottom: "1rem" }}>
              {tSafe(t, "visual.title", "Visual Architecture Breakdown")}
            </h2>
            <p style={{ opacity: 0.7, maxWidth: "900px", fontSize: "1rem", lineHeight: 1.6 }}>
              {tSafe(
                t,
                "visual.subtitle",
                "Understanding the layers of sovereign cost management."
              )}
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "0.9rem", opacity: 0.8, margin: 0 }}>
                {tSafe(t, "visual.diagram", "Interactive Architecture Schematic")}
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <h3 style={{ fontSize: "1.8rem", fontWeight: 900, margin: 0 }}>
                {tSafe(t, "visual.lockin.title", "Zero Lock-in Guarantee")}
              </h3>
            </div>
            <p style={{ opacity: 0.8, lineHeight: 1.7, fontSize: "1rem", marginBottom: "1.5rem" }}>
              {tSafe(t, "visual.lockin.desc1", "Our abstraction layer ensures logic portability.")}
            </p>
            <p style={{ opacity: 0.8, lineHeight: 1.7, fontSize: "1rem" }}>
              {tSafe(t, "visual.lockin.desc2", "Maintain full control over your cloud spending.")}
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            ...
            <h2 style={{ fontSize: "2.5rem", fontWeight: 950, marginBottom: "1rem" }}>
              {tSafe(t, "compliance.title", "Enterprise-Grade Compliance")}
            </h2>
            <p style={{ opacity: 0.7, maxWidth: "700px", margin: "0 auto", fontSize: "1rem" }}>
              {tSafe(
                t,
                "compliance.subtitle",
                "Built for regulated industries with strict data residency."
              )}
            </p>
          </div>
          ...
          <div id="faq" style={{ maxWidth: "900px", margin: "0 auto" }}>
            ...
            >
              {tSafe(t, "FAQ.title", "Pricing F.A.Q")}
            </h3>
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              {[
                {
                  q: tSafe(t, "FAQ.items.0.q", "How is pricing calculated?"),
                  a: tSafe(t, "FAQ.items.0.a", "Predictable sovereign node units."),
                },
                {
                  q: tSafe(t, "FAQ.items.1.q", "Can I switch plans?"),
                  a: tSafe(t, "FAQ.items.1.a", "Yes, any time with prorated adjustments."),
                },
                {
                  q: tSafe(t, "FAQ.items.2.q", "Do you offer custom tiers?"),
                  a: tSafe(
                    t,
                    "FAQ.items.2.a",
                    "Yes, for large enterprise and government entities."
                  ),
                },
              ].map((faq, idx) => (
                <div
      ...
      <section id="trust" className="snap-section" style={{ background: "var(--background)" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            <h2 style={{ fontSize: "2.5rem", fontWeight: 950, marginBottom: "1rem" }}>
              {tSafe(t, "trust.title", "Trust & Neutrality")}
            </h2>
            <p style={{ opacity: 0.7, maxWidth: "700px", margin: "0 auto", fontSize: "1rem" }}>
              {tSafe(t, "trust.subtitle", "Dedicated to ethical cloud stewardship.")}
            </p>
          </div>
          <div
            style={{
          ...
          >
            <div className="glass-panel" style={{ padding: "2rem", borderRadius: "1.25rem" }}>
              ...
              <h4 style={{ fontSize: "1.2rem", fontWeight: 800, marginBottom: "1rem" }}>
                {tSafe(t, "trust.residency.title", "Strict Residency")}
              </h4>
              <p style={{ fontSize: "0.95rem", opacity: 0.7, lineHeight: 1.6 }}>
                {tSafe(t, "trust.residency.desc", "Data never leaves your defined jurisdiction.")}
              </p>
            </div>
            <div className="glass-panel" style={{ padding: "2rem", borderRadius: "1.25rem" }}>
              <Globe color="var(--primary)" size={32} className="mb-3" />
              <h4 style={{ fontSize: "1.2rem", fontWeight: 800, marginBottom: "1rem" }}>
                {tSafe(t, "trust.neutrality.title", "Cloud Neutrality")}
              </h4>
              <p style={{ fontSize: "0.95rem", opacity: 0.7, lineHeight: 1.6 }}>
                {tSafe(
                  t,
                  "trust.neutrality.desc",
                  "Decoupled from any single hyperscale provider."
                )}
              </p>
            </div>
          </div>
      ...
      <DeepDive
        ...
        relatedLinks={[
          {
            label: tSafe(t, "DeepDive.links.modernization", "Cloud Modernization"),
            href: "/services/cloud-modernization",
          },
          {
            label: tSafe(t, "DeepDive.links.finance", "Sovereign Finance"),
            href: "/industries/finance",
          },
          {
            label: tSafe(t, "DeepDive.links.blueprint", "Modernization Blueprint"),
