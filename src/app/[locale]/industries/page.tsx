...
export default async function IndustriesPage() {
  ...
  return (
    <div className="animate-fade-in">
      {/* Hero */}
      <section
        className="relative w-full flex items-center justify-center overflow-hidden border-b border-white/10"
        style={{ minHeight: "calc(100vh - var(--header-height) - var(--breadcrumb-height))" }}
      >
        {/* Background Visual */}
        ...
        <div className="container relative z-10 flex flex-col items-center py-20">
          ...
          <div
            className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-5xl animate-fade-in-up"
          ...
          >
            {[
              ...
              },
              {
                ...
                value: "99.99%",
                icon: <Landmark className="text-amber-400" size={20} />,
              },
            ].map((stat, idx) => (
              <div
                key={idx}
                className="glass-panel p-6 rounded-2xl border border-white/5 bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 group"
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[0.7rem] uppercase tracking-widest text-muted-foreground font-bold">
                    {stat.label}
                  </span>
              ...
              {i % 2 === 0 ? (
                <>
                  <div>
                    ...
                    <div
                      ...
                      style={{ padding: "1rem", borderRadius: "1.25rem", marginBottom: "1rem" }}
                    >
                      <h4
                        style={{
                          color: "#60efff",
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p
                          style={{ color: "var(--foreground)", opacity: 0.6, fontSize: "0.85rem" }}
                        >
                          {item.solution}
                        </p>
                      </div>
                    ...
                    <Link
                      href={
                        item.id === "financial-services"
                          ? `/${locale}/industries/finance`
                          : item.id === "healthcare"
                            ? `/${locale}/industries/healthcare`
                            : "#"
                      }
                      className="btn-secondary py-2 px-6 rounded-lg text-sm font-bold inline-flex items-center gap-2"
                    >
                ...
                <>
                  ...
                  <div>
                    ...
                    <div
                      className="glass-panel"
                      style={{ padding: "1rem", borderRadius: "1.25rem", marginBottom: "1.5rem" }}
                    >
                      <h4
                        style={{
                          color: "#60efff",
      ...
      <section className="container" style={{ padding: "2rem 0", textAlign: "center" }}>
        <div
          className="glass-panel"
          style={{ padding: "3rem", borderRadius: "3.5rem", background: "var(--primary-glow)" }}
        >
          <h2
            style={{
              fontSize: "2.5rem",
          ...
          <Link
            ...
            style={{ padding: "0.8rem 2.5rem", fontSize: "1rem", borderRadius: "0.5rem" }}
          >
            {t("cta.button")}
          </Link>
        </div>
