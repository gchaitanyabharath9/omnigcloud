        ...
        <PageShell>
          <div className="max-w-4xl relative z-10">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link
                href={`/${locale}/use-cases/healthcare`}
        ...
        <PageShell>
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p
                className="text-lg opacity-80 leading-relaxed mb-6"
                dangerouslySetInnerHTML={{ __html: t.raw("paradox.p1") }}
              />
              <p
                className="text-lg opacity-80 leading-relaxed"
                dangerouslySetInnerHTML={{ __html: t.raw("paradox.p2") }}
              />
            </div>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-bold mb-2 text-xl">
                      {t(`paradox.features.${feature.key}.title`)}
                    </h4>
                    <p className="opacity-60 text-sm leading-relaxed">
                      {t(`paradox.features.${feature.key}.desc`)}
                    </p>
                  </div>
                </div>
              ))}
      ...
      <Section className="py-24 border-t border-white/5">
        <PageShell>
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <Link
              href={`/${locale}/services/microservices`}
            ...
            >
              <h4 className="text-2xl font-bold mb-4 group-hover:text-primary transition-colors">
                {t("footer.microservicesTitle")}
              </h4>
              <p className="opacity-60 text-sm mb-6">{t("footer.microservicesDesc")}</p>
              <div className="text-primary font-bold flex items-center gap-2">
                {t("footer.microservicesLink")} <ArrowRight size={14} />
              </div>
            </Link>
            <Link
              href={`/${locale}/services/ai-cloud-platform`}
              className="glass-panel p-10 rounded-[2.5rem] group hover:border-primary/50 transition-all"
            >
              <h4 className="text-2xl font-bold mb-4 group-hover:text-primary transition-colors">
                {t("footer.aiTitle")}
              ...
              <div className="text-primary font-bold flex items-center gap-2">
                {t("footer.aiLink")} <ArrowRight size={14} />
              </div>
            </Link>
          </div>
