        ...
        <PageShell>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl opacity-80 mb-8 leading-relaxed">{t(`${industry.key}.desc`)}</p>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 glass-panel p-8 rounded-3xl border border-primary/20 bg-primary/10 backdrop-blur-xl max-w-xs shadow-xl animate-float">
                ...
                <p className="text-sm opacity-90 leading-relaxed">{t(`${industry.key}.sol`)}</p>
              </div>
            </div>
          </div>
        </PageShell>
...
export async function generateStaticParams() {
  ...
  const slugs = ["financial-services", "insurance", "telecom", "healthcare", "logistics"];
