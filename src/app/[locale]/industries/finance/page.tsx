        ...
        <PageShell>
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link
                href={`/${locale}/use-cases/financial`}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p
                ...
                dangerouslySetInnerHTML={{ __html: t.raw("innovation.p1") }}
              />
              <p
                className="text-lg opacity-80 leading-relaxed"
                dangerouslySetInnerHTML={{ __html: t.raw("innovation.p2") }}
              />
            </div>
      ...
      <Section className="py-24 border-t border-white/5">
        <PageShell>
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            >
              <h4 className="text-2xl font-bold mb-4 group-hover:text-primary transition-colors">
                {t("footer.migrationTitle")}
              </h4>
              <p className="opacity-60 text-sm mb-6">{t("footer.migrationDesc")}</p>
              <div className="text-primary font-bold flex items-center gap-2">
                {t("footer.migrationLink")} <ArrowRight size={14} />
              </div>
            </Link>
          </div>
