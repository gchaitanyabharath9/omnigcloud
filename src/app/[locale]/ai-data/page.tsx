            ...
            <div className="container">
                <div className="grid-2-strict items-center mb-12">
                    ...
                    <div className="glass-panel" style={{
                        ...
                        <div style={{ position: 'absolute', inset: 0, opacity: 0.5 }}>
                            ...
                            <div style={{ position: 'absolute', top: '20%', left: '20%', width: '10px', height: '10px', background: '#3b82f6', borderRadius: '50%', boxShadow: '0 0 10px #3b82f6' }}></div>
                            <div style={{ position: 'absolute', top: '50%', left: '40%', width: '14px', height: '14px', background: '#8b5cf6', borderRadius: '50%', boxShadow: '0 0 15px #8b5cf6' }}></div>
                            <div style={{ position: 'absolute', top: '30%', left: '70%', width: '12px', height: '12px', background: '#ec4899', borderRadius: '50%', boxShadow: '0 0 12px #ec4899' }}></div>
                            <div style={{ position: 'absolute', top: '70%', left: '60%', width: '10px', height: '10px', background: '#10b981', borderRadius: '50%', boxShadow: '0 0 10px #10b981' }}></div>
                            <div style={{ position: 'absolute', top: '60%', left: '80%', width: '8px', height: '8px', background: '#f59e0b', borderRadius: '50%', boxShadow: '0 0 8px #f59e0b' }}></div>

                            {/* CSS Lines connecting nodes */}
                            <div style={{ position: 'absolute', top: '35%', left: '21%', width: '20%', height: '1px', background: 'linear-gradient(90deg, #3b82f6, #8b5cf6)', transformOrigin: 'left', transform: 'rotate(15deg)' }}></div>
                            <div style={{ position: 'absolute', top: '40%', left: '41%', width: '30%', height: '1px', background: 'linear-gradient(90deg, #8b5cf6, #ec4899)', transformOrigin: 'left', transform: 'rotate(-10deg)' }}></div>
                            <div style={{ position: 'absolute', top: '65%', left: '60%', width: '20%', height: '1px', background: 'linear-gradient(90deg, #10b981, #f59e0b)', transformOrigin: 'left', transform: 'rotate(10deg)' }}></div>
                        </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
                    ...
                    <div className="glass-panel" style={{ overflow: 'hidden', borderRadius: 'var(--radius)' }}>
                        <div style={{ height: '80px', background: 'linear-gradient(135deg, #7928ca 0%, #ff0080 100%)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <div className="img-card-container">
                        <img src="https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=800&q=80" alt="Data Lake" className="img-cover" />
                        <div className="card-overlay" style={{ background: 'linear-gradient(0deg, rgba(2,6,23,0.9) 30%, rgba(59, 130, 246, 0.2) 100%)' }}></div>
                    ...
                    {/* MLOps */}
                    <div className="glass-panel" style={{ overflow: 'hidden', borderRadius: 'var(--radius)' }}>
                        <div style={{ height: '80px', background: 'linear-gradient(135deg, #10b981 0%, #3b82f6 100%)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div id="advanced-analytics" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
                    <div className="glass-panel" style={{ overflow: 'hidden', borderRadius: 'var(--radius)', padding: 0 }}>
                        <div style={{ height: '80px', background: 'linear-gradient(135deg, #f59e0b 0%, #ef4444 100%)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    {/* AI Agents */}
                    <div className="glass-panel" style={{ overflow: 'hidden', borderRadius: 'var(--radius)', padding: 0 }}>
                        <div style={{ height: '80px', background: 'linear-gradient(135deg, #ff0080 0%, #7928ca 100%)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    {/* Data Governance */}
                    <div className="glass-panel" style={{ overflow: 'hidden', borderRadius: 'var(--radius)', padding: 0 }}>
                        <div style={{ height: '80px', background: 'linear-gradient(135deg, #64748b 0%, #0f172a 100%)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    {/* Vector Search */}
                    <div className="glass-panel" style={{ overflow: 'hidden', borderRadius: 'var(--radius)', padding: 0 }}>
                        <div style={{ height: '80px', background: 'linear-gradient(135deg, #8b5cf6 0%, #c026d3 100%)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <div className="glass-panel" style={{ overflow: 'hidden', borderRadius: 'var(--radius)', padding: 0 }}>
                        <div style={{ height: '80px', background: 'linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <div className="img-card-container">
                        <img src="https://images.unsplash.com/photo-1535378437327-b7149b32450a?w=800&q=80" alt="Computer Vision" className="img-cover" />
                        <div className="card-overlay" style={{ background: 'linear-gradient(0deg, rgba(2,6,23,0.9) 30%, rgba(236, 72, 153, 0.2) 100%)' }}></div>
                        <div className="card-content-overlay p-6 justify-end">
