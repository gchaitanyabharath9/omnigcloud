  ...
  return (
    <div id="intro" className="flex flex-col gap-8 pb-12">
      <div className="mb-8">
        ...
        <p className="text-base opacity-80 leading-relaxed">{t("hero.description")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div id="architecture" className="glass-panel p-5 rounded-2xl scroll-m-[120px]">
          ...
          <div className="text-[0.65rem] font-black text-primary mb-2 uppercase">
            {t("cards.architecture.exhibit")}
          </div>
          ...
          <Link
            ...
            className="text-primary font-extrabold text-sm flex items-center gap-1 no-underline hover:gap-2 transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div id="guide" className="glass-panel p-5 rounded-2xl scroll-m-[120px]">
          ...
          <div className="text-[0.65rem] font-black text-primary mb-2 uppercase">
            {t("cards.guide.exhibit")}
          </div>
          <p className="text-xs opacity-60 mb-4 leading-relaxed">{t("cards.guide.description")}</p>
          <Link
            href="/docs/guide"
            className="text-primary font-extrabold text-sm flex items-center gap-1 no-underline hover:gap-2 transition-all"
          >
        ...
        <div id="api" className="glass-panel p-5 rounded-2xl scroll-m-[120px]">
          ...
          <p className="text-xs opacity-60 mb-4 leading-relaxed">{t("cards.api.description")}</p>
          <Link
            href="/docs/api"
            className="text-primary font-extrabold text-sm flex items-center gap-1 no-underline hover:gap-2 transition-all"
          >
      ...
      <div
        id="governance"
        className="glass-panel mt-6 p-6 rounded-3xl bg-primary/5 scroll-m-[120px]"
      >
        <div className="flex items-center gap-3 mb-4">
          <ShieldCheck size={24} className="text-primary" />
          <h3 className="text-2xl font-black">{t("banner.title")}</h3>
        </div>
        <p className="text-sm opacity-70 mb-5 leading-relaxed">{t("banner.description")}</p>
        <Link
          href="/docs/governance"
          className="btn-primary inline-block py-2 px-6 text-sm no-underline"
        >
          {t("banner.cta")}
        </Link>
      </div>
