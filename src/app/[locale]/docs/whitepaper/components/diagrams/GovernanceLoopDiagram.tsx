...
export const GovernanceLoopDiagram = () => {
    const t = useTranslations('WhitePaper.detailedDiagrams.governance');
    return (
        <div style={{ padding: '2rem', background: 'var(--bg-surface-2)', borderRadius: '0.5rem', position: 'relative', overflow: 'hidden' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 2 }}>
                <div style={{ textAlign: 'center', width: '18%' }}>
                    ...
                    <div style={{ fontSize: '0.8rem', fontWeight: 800 }}>{t('signal.title')}</div>
                    <div style={{ fontSize: '0.7rem', opacity: 0.7 }}>{t('signal.desc')}</div>
                </div>
                ...
                <div style={{ textAlign: 'center', width: '18%' }}>
                    ...
                    <div style={{ fontSize: '0.8rem', fontWeight: 800 }}>{t('decision.title')}</div>
                    <div style={{ fontSize: '0.7rem', opacity: 0.7 }}>{t('decision.desc')}</div>
                </div>
                ...
                <div style={{ textAlign: 'center', width: '18%' }}>
                    ...
                    <div style={{ fontSize: '0.8rem', fontWeight: 800 }}>{t('action.title')}</div>
                    <div style={{ fontSize: '0.7rem', opacity: 0.7 }}>{t('action.desc')}</div>
                </div>
                ...
                <div style={{ textAlign: 'center', width: '18%' }}>
                    ...
                    <div style={{ fontSize: '0.8rem', fontWeight: 800 }}>{t('validation.title')}</div>
                    <div style={{ fontSize: '0.7rem', opacity: 0.7 }}>{t('validation.desc')}</div>
                </div>
            </div>
