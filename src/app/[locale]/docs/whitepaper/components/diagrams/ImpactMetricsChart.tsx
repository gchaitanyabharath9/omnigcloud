  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.5rem" }}>
      ...
      >
        ...
        >
          <div
            style={{ width: "20px", height: "100%", background: "#e2e8f0", borderRadius: "4px" }}
          ></div>
          <div
            style={{ width: "20px", height: "10%", background: "#10b981", borderRadius: "4px" }}
          ></div>
        </div>
      ...
      >
        ...
        >
          ...
          ></div>
          <div
            style={{ width: "20px", height: "69%", background: "#3b82f6", borderRadius: "4px" }}
          ></div>
        </div>
      ...
      >
        ...
        >
          <div
            style={{ width: "20px", height: "87%", background: "#e2e8f0", borderRadius: "4px" }}
          ></div>
          <div
            style={{ width: "20px", height: "100%", background: "#f59e0b", borderRadius: "4px" }}
          ></div>
        </div>
