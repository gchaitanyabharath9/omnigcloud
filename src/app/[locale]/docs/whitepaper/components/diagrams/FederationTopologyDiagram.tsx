      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ fontWeight: 800, fontSize: "0.8rem", color: "var(--foreground)" }}>
              {t("federationUsTitle")}
            </div>
          </div>
          <div style={{ fontSize: "0.7rem", opacity: 0.8, color: "var(--foreground)" }}>
            {t("federationUsPolicy")}
          </div>
          <div
            style={{
              marginTop: "0.5rem",
