...
export const SchematicDiagram: React.FC<SchematicDiagramProps> = ({ title, imagePath, children }) => (
    <div style={{ margin: '3rem 0', border: '1px solid var(--border)', borderRadius: '0.5rem', overflow: 'hidden', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
        ...
        <div style={{ padding: '2rem', background: 'var(--bg-surface)', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            {imagePath && (
