                ...
                <div className="glass-panel p-10 rounded-[2rem]">
                    ...
                    <div className="flex flex-col gap-6">
                        {[
                            ...
                            <div key={i} className="flex gap-4 items-center border-b border-card-border pb-4 last:border-0 last:pb-0">
                                <span className="font-black text-primary text-xs bg-primary/10 px-2 py-1 rounded-md">{api.method}</span>
