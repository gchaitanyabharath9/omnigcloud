...
export default async function A4GovernancePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    // Load MD content
    const filePath = path.join(process.cwd(), 'src/app/[locale]/research/papers/a4-platform-governance-multicloud-hybrid/A4-PAPER-FULL.md');
            ...
            <header className="relative py-24 overflow-hidden border-b border-white/5">
                ...
                <div className="container relative z-10 mx-auto px-4">
                    ...
                    <div className="flex flex-wrap items-center gap-8 text-sm font-mono text-slate-400">
                        ...
                        <div className="flex items-center gap-2">
                            <Tag size={16} className="text-primary" /> Governance Patterns
                        </div>
                        <div className="flex items-center gap-2">
                            <FileText size={16} className="text-primary" /> 60-Page Analysis
                        </div>
                    </div>
                </div>
            </header>
                    ...
                    <aside className="lg:col-span-4 space-y-12">
                        ...
                        <div className="p-8 rounded-2xl bg-white/5 border border-white/10 sticky top-24">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed mb-6 italic">
                                "This research defines the 'Sovereign Boundary' concept for multi-cloud governance.
                                It advocates for moving compliance checks out of pipelines and into the runtime via admission controllers (OPA)."
                            </p>

                            <Link
                                href={`/${locale}/contact?subject=Paper%20Request:%20A4`}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between text-xs font-mono border-b border-white/5 pb-2">
                                    <span className="text-slate-500">Key Technology</span>
                                    <span className="text-primary">Policy-as-Code</span>
                                </div>
