            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify(generateArticleSchema({
                        ...
                        image: 'https://www.omnigcloud.com/og-images/papers/a3-observability.png',
                        url: `https://www.omnigcloud.com/${locale}/research/papers/a3-enterprise-observability-operational-intelligence`,
                    }))
                }}
            />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <aside className="lg:col-span-4 space-y-12">
                        ...
                        <div className="p-8 rounded-2xl bg-white/5 border border-white/10 sticky top-24">
                            ...
                            <a
                                href="/pdfs/A3-Observability-Signed.pdf"
