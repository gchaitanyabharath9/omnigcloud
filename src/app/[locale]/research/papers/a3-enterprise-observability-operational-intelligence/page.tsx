...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: 'Enterprise Observability & Operational Intelligence | OmniGCloud',
...
export default async function A3ObservabilityPage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const contentPath = path.join(process.cwd(), 'src/app/[locale]/research/papers/a3-enterprise-observability-operational-intelligence/A3-PAPER-FULL.md');
                        ...
                        <header className="mb-16 border-b border-white/10 pb-12">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm font-mono text-muted-foreground">
                                ...
                                <div>
                                    ...
                                    <div className="text-foreground">Best Practice</div>
                                </div>
                            </div>
                        </header>
                                ...
                                if (part.type === 'text') {
                                    ...
                                    return (
                                        <MermaidDiagram
                                            key={index}
                                            chart={part.content}
                                            caption="Observability Architecture"
