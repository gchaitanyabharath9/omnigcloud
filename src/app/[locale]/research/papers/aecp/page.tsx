...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    const baseMetadata = generateSEOMetadata({
        ...
        canonical: `https://www.omnigcloud.com/${locale}/research/papers/aecp`,
...
export default async function AECPPage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const contentPath = path.join(process.cwd(), 'src/app/[locale]/research/papers/aecp/AECP-FULL.md');
    let fileContent = '';
    try {
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify(generateArticleSchema({
                        ...
                        url: `https://www.omnigcloud.com/${locale}/research/papers/aecp`,
                    }))
                }}
            />
