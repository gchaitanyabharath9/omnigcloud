...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "Papers.AECP" });
  return {
    title: t("meta.title"),
    description: t("meta.description"),
    alternates: { canonical: `https://www.omnigcloud.com/${locale}/research/papers/aecp` },
  };
}
    ...
    <div className="min-h-screen bg-[#020617] text-slate-200">
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto p-8 rounded-2xl bg-white/5 border border-white/10">
          ...
          <Link
            href={`/${locale}/contact?subject=Paper%20Request:%20AECP`}
