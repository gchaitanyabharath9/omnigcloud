...
export default async function ScholarlyArticlePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const contentPath = path.join(process.cwd(), 'src/app/[locale]/research/papers/scholarly-article/SCHOLARLY-ARTICLE-ENTERPRISE-ARCHITECTURE.md');
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify(generateArticleSchema({
                        ...
                        image: 'https://www.omnigcloud.com/og-images/research/scholarly-article.png',
                        url: `https://www.omnigcloud.com/${locale}/research/papers/scholarly-article`,
                    }))
                }}
            />
