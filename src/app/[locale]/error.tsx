    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "1.1rem", opacity: 0.7, marginBottom: "2.5rem", lineHeight: 1.6 }}>
          {t("description", {
            fallback: "A critical exception has occurred in the sovereign control plane.",
          })}
        </p>
        ...
        >
          ...
          <div style={{ wordBreak: "break-all" }}>{error.message || "RUNTIME_EXCEPTION_0x884"}</div>
        </div>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          >
            ...
            {t("retry", { fallback: "Re-Initialize" })}
          </button>
          <Link href="/" className="btn-secondary">
            <Home size={18} style={{ marginRight: "0.5rem" }} />{" "}
            {t("home", { fallback: "Operations" })}
          </Link>
        </div>
      </div>
    </div>
