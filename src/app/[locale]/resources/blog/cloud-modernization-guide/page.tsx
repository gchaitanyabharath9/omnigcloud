                ...
                <PageShell>
                    <div className="max-w-3xl mx-auto">
                        ...
                        <h1 className="text-5xl md:text-6xl font-black mb-8 leading-tight">
                            {t('hero.titlePrefix')} <span className="text-primary">{t('hero.titleHighlight')}</span> {t('hero.titleSuffix')}
                        </h1>
                        ...
                        <div className="prose prose-invert prose-lg max-w-none leading-relaxed">
                            ...
                            <p className="mb-6" dangerouslySetInnerHTML={{ __html: t.raw('body.pillar4.text') }} />
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <Link href={`/${locale}/docs/whitepaper`} className="group">
                                ...
                                <span className="text-primary text-xs font-bold flex items-center gap-2">{t('related.readWhitepaper')} <ArrowRight size={12} /></span>
                            </Link>
                        </div>
                    </div>
                </PageShell>
