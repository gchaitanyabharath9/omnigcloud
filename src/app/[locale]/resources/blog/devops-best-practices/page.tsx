...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      "Explore the essential DevOps patterns for managing complex multi-cloud and sovereign environments. Learn about GitOps, policy-as-code, and automated gating.",
    keywords: [
...
export default async function DevOpsBestPracticesPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
        ...
        <PageShell>
          <div className="max-w-4xl mx-auto flex justify-between items-center">
            <Link
              ...
              className="text-sm font-bold flex items-center gap-2 opacity-50 hover:opacity-100 transition-opacity"
            >
