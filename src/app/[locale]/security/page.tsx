  ...
  return (
    <>
      ...
      <section
        ...
        style={{ background: "var(--bg-surface-2)", padding: "4rem 0" }}
      >
        ...
        <div className="container" style={{ maxWidth: "1200px" }}>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="glass-panel p-8 rounded-xl">
              ...
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">{t("transparency.desc")}</p>
        ...
        <div className="container" style={{ maxWidth: "1200px" }}>
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="glass-panel p-8 rounded-xl flex flex-col justify-center">
              ...
              <p className="text-zinc-700 dark:text-zinc-300 mb-6">{t("contactText")}</p>
              <div className="bg-zinc-100 dark:bg-zinc-800 p-6 rounded-lg">
