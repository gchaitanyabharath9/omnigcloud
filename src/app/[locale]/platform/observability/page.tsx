      ...
      <div className="container">
        ...
        <div className="max-w-4xl mb-24">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/docs/whitepaper" className="btn-secondary py-4 px-10">
              {t("hero.cta2")}
            </Link>
          </div>
        </div>
            ...
            <div className="order-2 lg:order-1">
              <div className="glass-panel p-8 border-primary/20 bg-slate-900/40 relative">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="px-3 py-1 bg-primary/20 text-primary text-[10px] font-black rounded-lg">
                    {t("mesh.badge")}
                  </div>
                </div>
