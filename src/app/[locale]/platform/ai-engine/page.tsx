      ...
      <div className="container">
        ...
        <div className="max-w-4xl mb-24">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/architecture" className="btn-secondary py-4 px-10">
              {t("hero.cta2")}
            </Link>
          </div>
        </div>
        ...
        <div className="py-24 border-y border-white/5 bg-slate-900/50 -mx-4 px-4 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={i}
                className="glass-panel p-8 text-center group hover:border-primary/50 transition-all"
              >
                <step.icon
                  size={40}
                  className="text-primary mx-auto mb-6 group-hover:scale-110 transition-transform"
                />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                {[{ id: "graph" }, { id: "policy" }, { id: "benchmark" }].map((s, i) => (
            ...
            <div className="glass-panel p-1 border-primary/20 bg-black/40 overflow-hidden group">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, transparent 50%, rgba(99, 102, 241, 0.1) 51%, transparent 51%)",
