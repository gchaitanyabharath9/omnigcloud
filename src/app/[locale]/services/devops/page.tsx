  ...
  return generateSEOMetadata(
    {
      ...
      description:
        "Accelerate your delivery cycle with our sovereign DevOps practices. We implement secure CI/CD, GitOps workflows, and automated infrastructure as code.",
      keywords: [
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p
                ...
                dangerouslySetInnerHTML={{ __html: t.raw("evolution.description1") }}
              />
              <p className="text-lg opacity-80 leading-relaxed">{t("evolution.description2")}</p>
            </div>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-bold mb-2 text-xl">
                      {t(`evolution.features.${feature.key}.title`)}
                    </h4>
                    <p className="opacity-60 text-sm leading-relaxed">
                      {t(`evolution.features.${feature.key}.desc`)}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-invert prose-slate max-w-none">
              <p
                ...
                dangerouslySetInnerHTML={{ __html: t.raw("tech.stackDesc") }}
              />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {[0, 1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="glass-panel p-6 rounded-2xl border-white/5 hover:border-primary/20 transition-colors"
                >
