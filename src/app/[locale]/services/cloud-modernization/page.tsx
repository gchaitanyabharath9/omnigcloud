      ...
      <Section className="py-24 border-y border-white/5 bg-[#050810]/50">
        <PageShell>
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-xs font-black text-red-500 uppercase tracking-[0.2em] mb-4">
                {t("challenge.badge")}
              </h2>
            ...
            <div className="glass-panel p-10 border-red-500/10 relative">
              <div className="text-5xl font-black text-red-500/20 mb-4">
                {t("challenge.lostRoi")}
              </div>
              <p className="italic text-slate-400 mb-6">{t("challenge.quote")}</p>
              <div className="text-xs font-mono text-red-500 opacity-50">
                {t("challenge.errorCode")}
              </div>
            </div>
          </div>
        </PageShell>
        ...
        <PageShell>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="glass-panel p-8 relative overflow-hidden group hover:border-primary/50 transition-all"
              >
                <span className="absolute top-4 right-4 text-4xl font-black text-white/5 group-hover:text-primary/10 transition-colors tracking-tighter">
                  {item.step}
                </span>
                <item.icon size={40} className="text-primary mb-6" />
                <h4 className="text-xl font-bold mb-4">{t(`pipeline.${item.key}.title`)}</h4>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  {t(`pipeline.${item.key}.desc`)}
                </p>
              </div>
            ))}
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[0, 1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="glass-panel p-6 border-white/5 bg-background rounded-2xl hover:border-primary/30 transition-colors"
                >
        ...
        <PageShell>
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <Link
              ...
              className="glass-panel p-10 rounded-[2.5rem] group hover:border-primary/50 transition-all bg-gradient-to-br from-transparent to-primary/5"
            >
            ...
            <Link
              ...
              className="glass-panel p-10 rounded-[2.5rem] group hover:border-primary/50 transition-all bg-gradient-to-br from-transparent to-blue-500/5"
            >
              ...
              <div className="text-blue-400 font-bold flex items-center gap-2">
                {t("footer.readGuide")} <ArrowRight size={14} />
              </div>
            </Link>
          </div>
