            ...
            <Section className="py-24 border-y border-white/5">
                <PageShell>
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        <div>
                            <h2 className="text-sm font-black text-primary uppercase tracking-widest mb-6">{t('journey.badge')}</h2>
                            <h3 className="text-4xl font-bold mb-8">{t('journey.title')}</h3>
                            <p className="text-lg opacity-80 leading-relaxed mb-6">
                                {t('journey.p1')}
                            </p>
                            <p className="text-lg opacity-80 leading-relaxed" dangerouslySetInnerHTML={{ __html: t.raw('journey.p2') }} />
                        </div>
                        <div className="grid grid-cols-1 gap-6">
                            {[
                                ...
                                <div key={i} className="glass-panel p-6 rounded-2xl flex gap-6 items-start hover:border-primary/30 transition-all">
                                    ...
                                    <div>
                                        <h4 className="font-bold mb-2 text-xl">{t(`journey.features.${feature.key}.title`)}</h4>
                                        <p className="opacity-60 text-sm leading-relaxed">{t(`journey.features.${feature.key}.desc`)}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
