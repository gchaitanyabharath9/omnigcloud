      ...
      <div className="container" style={{ padding: "2rem" }}>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: "1.5rem", fontWeight: 950, color: "#10b981" }}>
              {t("metrics.healthStatus")}
            </div>
          </div>
        </div>
