...
export default async function BlogPage() {
  ...
  const posts = [
    ...
    },
    {
      ...
      slug: "/resources/blog/cloud-modernization-guide",
    },
    {
      id: "sovereignty-framework",
      date: "Jan 08, 2026",
      readTime: "15 min read",
      image:
        "https://images.unsplash.com/photo-1639322537228-f710d846310a?auto=format&fit=crop&q=80&w=800",
      slug: "/resources/blog/sovereignty-framework",
    },
    {
      id: "cio-exit-strategy",
      date: "Jan 10, 2026",
      readTime: "18 min read",
      image:
        "https://images.unsplash.com/photo-1454165833767-027ee7a4477c?auto=format&fit=crop&q=80&w=800",
      slug: "/resources/blog/cio-exit-strategy",
    },
    {
      id: "devops-practices",
      date: "Jan 04, 2026",
      ...
      image:
        "https://images.unsplash.com/photo-1667372333374-0d3c0ec3a28c?auto=format&fit=crop&q=80&w=800",
      slug: "/resources/blog/devops-best-practices",
    },
    {
      id: "prompt",
      date: "Dec 10, 2025",
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                      ...
                      <span style={{ fontSize: "0.9rem", fontWeight: 700 }}>
                        {t(`posts.${post.id}.author`)}
                      </span>
                    </div>
                    <Link
                      href={getPostUrl(post, idx)}
                      style={{
                        display: "flex",
                        alignItems: "center",
                        gap: "0.5rem",
      ...
      <section style={{ padding: "4rem 0" }}>
        <div className="container">
          ...
          >
            ...
            <p style={{ fontSize: "0.7rem", opacity: 0.4, marginTop: "1.5rem" }}>
              {t("newsletter.footer")}
            </p>
          </div>
        </div>
