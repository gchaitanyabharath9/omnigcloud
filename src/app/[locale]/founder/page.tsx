                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-1/3">
                                ...
                                <div className="relative bg-[#0a0f1d] border border-white/10 rounded-2xl overflow-hidden aspect-[4/5]">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-[#1e293b]">
                                        ...
                                        <div className="text-center">
                                            ...
                                            <p className="text-xs text-blue-400 font-mono text-uppercase">{t("hero.role").toUpperCase()}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="mt-8 flex justify-center gap-4">
                                ...
                                <a href={`mailto:${tCompany('email')}`} className="p-3 bg-white/5 hover:bg-blue-500/10 rounded-full transition-colors"><Mail size={20} /></a>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <div>
                            ...
                            <Link href="/research" className="mt-8 inline-flex items-center gap-2 text-blue-500 font-bold hover:underline">
                    ...
                    <div className="max-w-4xl mx-auto bg-gradient-to-br from-blue-600 to-blue-800 p-1 rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/20">
                        <div className="bg-[#0a0f1d] p-12 lg:p-20 rounded-[22px]">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-4">
                                <Link href="/contact" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-10 rounded-xl transition-all hove:scale-105">
                                    {t("cta.audit")}
                                </Link>
                                <Link href="/docs/whitepaper" className="bg-white/5 hover:bg-white/10 text-white font-bold py-4 px-10 rounded-xl transition-all border border-white/10">
                                    {t("cta.read")}
                                </Link>
                            </div>
                        </div>
