...
export default function FounderPage() {
  ...
  const stats = [
    { l: t("hero.stats.exp"), v: t("hero.stats.expValue") },
    { l: t("hero.stats.certs"), v: t("hero.stats.certsValue") },
    { l: t("hero.stats.papers"), v: t("hero.stats.papersValue") },
    { l: t("hero.stats.patents"), v: t("hero.stats.patentsValue") },
  ];

  const experienceItems = [
    { t: t("experience.items.0.title"), d: t("experience.items.0.desc") },
    { t: t("experience.items.1.title"), d: t("experience.items.1.desc") },
    { t: t("experience.items.2.title"), d: t("experience.items.2.desc") },
    { t: t("experience.items.3.title"), d: t("experience.items.3.desc") },
  ];
  ...
  return (
    <div className="snap-container">
      {/* HERO SECTION */}
      <section
        className="snap-section relative py-24 border-b border-white/5 overflow-hidden"
        style={{
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/3">
                ...
                <div className="relative bg-[#0a0f1d] border border-white/10 rounded-2xl overflow-hidden aspect-[4/5]">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-[#1e293b]">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs text-blue-400 font-mono text-uppercase">
              ...
              <div className="mt-8 flex justify-center gap-4">
                <a
                  href="#"
                  className="p-3 bg-white/5 hover:bg-blue-500/10 rounded-full transition-colors"
                >
                  <Linkedin size={20} />
                </a>
                <a
            ...
            <div className="lg:w-2/3">
              <div className="flex items-center gap-2 text-blue-500 font-mono text-sm font-bold tracking-widest uppercase mb-4">
                <Award size={16} /> {t("hero.visionary")}
              </div>
              <h1 className="text-5xl lg:text-7xl font-black mb-6 tracking-tight">{t("name")}</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-10 flex items-center gap-3">
                <Briefcase className="text-blue-500" /> {t("experience.title")}
              </h2>
            ...
            <div>
              <h2 className="text-3xl font-bold mb-10 flex items-center gap-3">
                <BookOpen className="text-blue-500" /> {t("research.title")}
              </h2>
              <div className="space-y-4">
                {publications.map((pub, i) => (
                  <div
                    key={i}
                    className="bg-white/5 p-5 rounded-xl border border-white/5 flex items-center justify-between group hover:border-blue-500/30 transition-colors"
                  >
              ...
              <Link
                href="/research"
                className="mt-8 inline-flex items-center gap-2 text-blue-500 font-bold hover:underline"
              >
                {t("research.viewRepo")} <ChevronRight size={16} />
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container text-center">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-blue-600 to-blue-800 p-1 rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/20">
            <div className="bg-[#0a0f1d] p-12 lg:p-20 rounded-[22px]">
              ...
              <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">{t("cta.text")}</p>
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link
                  href="/contact"
                  className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-10 rounded-xl transition-all hove:scale-105"
                >
                  {t("cta.audit")}
                </Link>
                <Link
                  href="/docs/whitepaper"
                  className="bg-white/5 hover:bg-white/10 text-white font-bold py-4 px-10 rounded-xl transition-all border border-white/10"
                >
                  {t("cta.read")}
                </Link>
              </div>
