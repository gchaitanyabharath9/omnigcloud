...
import { Landmark, Heart, ShieldCheck, ShoppingCart, Factory, Radio, Zap, GraduationCap } from 'lucide-react';
...
export const USE_CASES = [
    ...
    },
    {
        ...
        description: "Transform factory operations with edge computing and real-time analytics processing data from 100,000+ IoT sensors. Implement predictive maintenance using machine learning models to reduce downtime by 40% and extend equipment lifespan. Optimize supply chain logistics with AI-powered demand forecasting and automated inventory management. Ensure operational technology (OT) security with network segmentation and zero-trust architecture.",
        explanation: "Image A captures the digital twin visualization of manufacturing processes, showing real-time production metrics, quality control data, and equipment health status across 15 global facilities. Image B displays our predictive maintenance dashboard analyzing vibration patterns, temperature fluctuations, and performance metrics to forecast equipment failures 72 hours in advance.",
