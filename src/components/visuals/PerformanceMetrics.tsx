          ...
          >
            <div
              style={{
                ...
                background:
                  i === costs.length - 1 ? "var(--color-success)" : "rgba(59, 130, 246, 0.6)",
      ...
      <svg width="100%" height="60" viewBox="0 0 200 60" preserveAspectRatio="none">
        ...
        <polyline
          points={errorRates
            .map(
              (rate, i) =>
                `${(i / (errorRates.length - 1)) * 200},${60 - (rate / Math.max(...errorRates)) * 50}`
            )
            .join(" ")}
...
export const ContainerEfficiency = () => {
  ...
  const metrics = [
    ...
    {
      name: tSafe(t, "memoryEfficiency", "Memory Efficiency"),
      value: 82,
      target: 80,
      color: "#3b82f6",
    },
    {
      name: tSafe(t, "networkEfficiency", "Network Efficiency"),
      value: 91,
      target: 85,
      color: "#8b5cf6",
    },
