    ...
    >
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-xs opacity-60 font-mono uppercase tracking-widest text-primary">
      ...
      <div className="relative h-64 w-full flex items-end gap-1 px-2 border-b border-l border-white/10">
        ...
        {months.map((m, i) => (
          <div
            key={m}
            className="flex-1 flex flex-col justify-end items-center gap-[2px] group relative h-full"
          >
            {/* AWS Bar */}
            ...
            {(activeCloud === "all" || activeCloud === "azure") && (
              <div
                ...
                style={{
                  height: `${(data.azure[i] / maxVal) * 100}%`,
                  transitionDelay: `${i * 20}ms`,
                }}
              ></div>
            )}
      ...
      <div className="mt-8 grid grid-cols-3 gap-4">
        <div className="p-3 rounded-xl bg-white/5 border border-white/10">
          <div className="text-[10px] opacity-40 uppercase font-black mb-1">
            {t("projectedSavings")}
          </div>
