      ...
      >
        <div>
          ...
          <input
            ...
            style={{ width: "100%", accentColor: "#60efff" }}
          />
          <div
            style={{ textAlign: "center", fontWeight: 800, color: "white", marginTop: "0.5rem" }}
          >
            {vms} Units
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            max="32"
            value={gpuUnits}
            onChange={(e) => setGpuUnits(parseInt(e.target.value))}
            style={{ width: "100%", accentColor: "#60efff" }}
          />
          <div
            style={{ textAlign: "center", fontWeight: 800, color: "white", marginTop: "0.5rem" }}
            ...
            return (
              ...
              >
                {isBestValue && (
                  <span
                    style={{
                      ...
                      borderRadius: "0 0.8rem 0 0.8rem",
                      fontWeight: 800,
                    }}
                  >
                    {t("bestValue")}
                ...
                <div
                  style={{
                    fontSize: "0.9rem",
                    color: isBestValue ? "#60efff" : "rgba(255,255,255,0.5)",
                    fontWeight: 700,
                    marginBottom: "0.5rem",
                  }}
                >
                ...
                <div style={{ fontSize: "1.8rem", fontWeight: 900, color: "white" }}>
                  ${est.monthlyCost.toLocaleString()}
                </div>
                <div
                  style={{
                    fontSize: "0.7rem",
                    color: isBestValue ? "rgba(96,239,255,0.7)" : "rgba(255,255,255,0.3)",
                    marginTop: "0.5rem",
                  }}
                >
                  {est.advantage}
