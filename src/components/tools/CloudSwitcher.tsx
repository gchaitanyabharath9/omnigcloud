...
export default function CloudSwitcher() {
    ...
    return (
        <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ fontSize: '1.1rem', marginBottom: '1.5rem', borderBottom: '1px solid rgba(96, 239, 255, 0.2)', paddingBottom: '0.75rem', color: '#60efff', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em' }}>{t('title')}</h3>

            <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', marginBottom: '2rem' }}>
                <div style={{ flex: 1, textAlign: 'center' }}>
                    <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>☁️</div>
                    <div style={{ fontWeight: 'bold', fontSize: '1.2rem', color: 'white' }}>{t('currentHost')}</div>
                ...
                <div style={{ flex: 1 }}>
                    <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500', color: 'white' }}>{t('targetCloud')}</label>
            ...
            <div style={{
                background: status === t('active') ? 'rgba(16, 185, 129, 0.2)' : 'rgba(251, 191, 36, 0.2)',
