    ...
    return (
        <div className="glass-panel p-5 rounded-2xl flex flex-col justify-between hover:border-primary/30 transition-all group">
            <div className="flex justify-between items-start mb-4">
                ...
                {trend && (
                    <div className={`flex items-center gap-1 text-xs font-black ${trendUp ? 'text-emerald-400' : 'text-rose-400'}`}>
            ...
            <div className="flex items-end justify-between gap-4">
                ...
                <div className="opacity-40 group-hover:opacity-100 transition-opacity">
                    <DemoSparkline color={color} width={80} height={30} data={trendUp ? [10, 20, 15, 30, 25, 45] : [45, 30, 35, 20, 25, 10]} />
                </div>
            </div>
        </div>
    );
