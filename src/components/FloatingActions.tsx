...
export default function FloatingActions() {
  ...
  return (
    <>
      ...
      {showChat && (
        <div
          className={twMerge("glass-panel", styles.widgetContainer)}
      ...
      {showContact && (
        <div
          className={twMerge("glass-panel", styles.widgetContainer)}
          style={{ height: "auto", fontFamily: "var(--font-inter)" }}
        >
          {/* Contact Header */}
          <div
            style={{
