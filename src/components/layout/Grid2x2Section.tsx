                ...
                <div style={{
                    ...
                    <div style={{ order: reverse ? 2 : 1 }}>
                        <div className="glass-panel" style={{ padding: '1.5rem', borderRadius: '1.5rem', height: '100%', display: 'flex', flexDirection: 'column' }}>
                            ...
                            <p style={{ fontSize: '1rem', opacity: 0.8, lineHeight: 1.6, marginBottom: '2rem' }}>{description}</p>

                            <div style={{ marginTop: 'auto', background: 'rgba(255,255,255,0.03)', padding: '1.5rem', borderRadius: '1.5rem', borderLeft: `6px solid ${accentColor}` }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem', order: reverse ? 1 : 2 }}>
                        {/* Image A */}
                        <div className="glass-panel" style={{ borderRadius: '1.5rem', overflow: 'hidden', height: '280px', border: '1px solid var(--card-border)' }}>
