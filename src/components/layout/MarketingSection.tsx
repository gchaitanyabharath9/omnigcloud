      ...
      <div className="container">
        {(title || badge) && (
          <div className="text-center mb-12">
            {badge && <div className="badge badge-primary-subtle mb-4 inline-block">{badge}</div>}
            {title && <h2 className="text-4xl font-black mb-4 tracking-tight">{title}</h2>}
            {subtitle && <p className="text-lg opacity-70 max-w-3xl mx-auto">{subtitle}</p>}
          </div>
        )}
        {children}
      </div>
