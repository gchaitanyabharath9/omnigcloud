...
const LatencyChart = dynamic(
  () => import("../../charts/MetricsCharts").then((mod) => mod.LatencyChart),
  { loading: () => <ChartSkeleton /> }
);
const RpsChart = dynamic(() => import("../../charts/MetricsCharts").then((mod) => mod.RpsChart), {
  loading: () => <ChartSkeleton />,
});
const ErrorRateChart = dynamic(
  () => import("../../charts/MetricsCharts").then((mod) => mod.ErrorRateChart),
  { loading: () => <ChartSkeleton /> }
);
...
export default function SecurityPerformanceSection() {
  ...
  return (
    <section className="glass-panel p-8 rounded-xl mb-8">
      ...
      <p className="text-zinc-700 dark:text-zinc-300 mb-8">{t("description")}</p>
