  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=1600&fit=crop)",
          opacity: 0.05,
        }}
      ></div>
      <div className="container relative z-10">
        ...
        <div className="grid-2-strict">
          ...
          <div className="img-card-container">
            <img
              src="https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=800&fit=crop"
              alt="Server Matrix"
              className="img-cover"
              style={{ opacity: 0.6 }}
            />
