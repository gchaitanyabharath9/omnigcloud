        ...
        <div className="grid-2x2-strict">
          ...
          <div className="img-card-container">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(0deg, rgba(88, 28, 135, 0.9) 0%, rgba(88, 28, 135, 0.4) 100%)",
              }}
            ></div>
            <div className="card-content-overlay p-6 justify-end">
              <div className="icon-circle mb-2 bg-white/10">
          ...
          <div className="img-card-container">
            <img
              src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&fit=crop"
              alt={t("images.audit")}
              className="img-cover"
            />
