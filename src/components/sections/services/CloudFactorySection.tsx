        ...
        <section id="cloud-factory" className="snap-section" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', paddingTop: 'var(--section-pt)' }}>
            <div className="container">
                ...
                <div className="img-card-container">
                    <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?w=800&q=80" alt="Azure Data Center" className="img-cover" />
                    <div className="card-overlay" style={{ background: 'linear-gradient(0deg, rgba(2,6,23,0.95) 40%, rgba(59, 130, 246, 0.2) 100%)' }}></div>
                ...
                <div className="card-feature justify-center relative overflow-hidden group">
                    <div style={{ position: 'absolute', top: 0, right: 0, width: '100%', height: '100%', background: 'radial-gradient(circle at top right, rgba(239, 68, 68, 0.1), transparent 50%)' }}></div>
                ...
                <div className="img-card-container">
                    <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80" alt="Circuit Board" className="img-cover" />
                    <div className="card-overlay" style={{ background: 'linear-gradient(0deg, rgba(2,6,23,0.95) 40%, rgba(96, 239, 255, 0.2) 100%)' }}></div>
                    <div className="card-content-overlay p-6 justify-end">
                ...
                <div className="card-feature justify-center relative overflow-hidden">
                    <div style={{ position: 'absolute', bottom: 0, left: 0, width: '100%', height: '100%', background: 'radial-gradient(circle at bottom left, rgba(16, 185, 129, 0.1), transparent 50%)' }}></div>
                    <div className="flex justify-between items-start w-full mb-4 relative z-10">
