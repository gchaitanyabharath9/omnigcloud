          ...
          <div className="grid-2-strict items-center">
            ...
            <div>
              ...
              <p className="text-lead mb-8">
                {t.rich("subtitle", {
                  span: (chunks) => (
                    <span style={{ color: "var(--primary)", fontWeight: 800 }}>{chunks}</span>
                  ),
                })}
              </p>
              ...
              <div className="flex gap-3 flex-wrap">
                {[
                  ...
                  {
                    n: ".NET Core",
                    img: "https://images.unsplash.com/photo-1593720213428-28a5b9e94613?w=200&q=80",
                  },
                  {
                    n: "Node.js",
                    img: "https://images.unsplash.com/photo-1627398242454-45a1465c2479?w=200&q=80",
                  },
                  {
                    n: "Python",
                    img: "https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=200&q=80",
                  },
                  {
                    n: "Go",
                    img: "https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=200&q=80",
                  },
                ].map((tech, i) => (
                  <div
                    key={i}
                    className="relative overflow-hidden rounded-md border border-white/10 w-24 h-12 flex items-center justify-center group"
                  >
                    <img
                      src={tech.img}
                      alt={tech.n}
            ...
            <div className="flex flex-col gap-4 h-full">
              <div className="img-card-container h-64">
                <img
                  src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&fit=crop"
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(45deg, rgba(2,6,23,0.8), rgba(59, 130, 246, 0.2))",
                  }}
                ></div>
