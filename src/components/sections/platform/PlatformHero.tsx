    ...
    >
      ...
      <div
        style={{
          ...
          height: "100%",
          backgroundImage:
            "url(https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1600&fit=crop&q=80)",
      ...
      <div className="grid-2-strict items-center gap-12">
        ...
        <div>
          <div className="flex gap-2 mb-4">
            {["Governance-v4", "Global-Sovereignty", "Multi-Cloud-Canvas"].map((c) => (
              <span key={c} className="badge badge-primary-subtle text-xs font-black">
                {c}
              </span>
            ))}
          </div>
          <h1 className="mb-6 leading-tight">{t("hero.title")}</h1>
          <p className="text-lead mb-8">{t("hero.subtitle")}</p>
        ...
        <div className="grid-2x2 gap-4">
          ...
          <div className="img-card-container col-span-2 h-48">
            <img
              src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&fit=crop"
              alt="Server Core"
              className="img-cover"
            />
            <div
              className="card-overlay"
              style={{ background: "linear-gradient(to top, var(--card-bg) 10%, transparent)" }}
            ></div>
          ...
          {[
            ...
            },
            {
              l: t("stack.logic"),
              v: t("stack.active"),
              img: "https://images.unsplash.com/photo-1544197150-b99a580bbcbf?w=400&q=80",
            },
            {
              l: t("stack.cluster"),
              v: t("stack.scaling"),
              img: "https://images.unsplash.com/photo-1518432031352-d6fc5c10da5a?w=400&q=80",
            },
            {
              l: t("stack.db"),
              v: t("stack.verified"),
            ...
            <div key={i} className="img-card-container h-32">
              ...
              <div className="card-content-overlay p-4 justify-center items-center text-center">
                ...
                <span className="text-xs font-black text-primary px-2 py-1 bg-white/10 rounded">
                  {m.v}
                </span>
              </div>
            </div>
