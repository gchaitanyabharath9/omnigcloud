    ...
    <section className="snap-section" style={{ background: "var(--bg-surface-2)" }}>
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          <h2 style={{ fontSize: "2.5rem", fontWeight: 950, marginBottom: "1.5rem" }}>
            {t("title")}
          </h2>
        ...
        >
          <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
            <thead>
              ...
              >
                <th style={{ padding: "2rem", fontSize: "1.2rem", fontWeight: 900 }}>
                  {t("capability")}
                </th>
                <th style={{ padding: "2rem", fontSize: "1.2rem", fontWeight: 900, opacity: 0.5 }}>
                  {t("legacy")}
                </th>
                <th
                  style={{
            ...
            <tbody>
              {rows.map((row, idx) => (
                <tr key={idx} style={{ borderBottom: "1px solid var(--card-border)" }}>
                  <td style={{ padding: "1.5rem 2rem", fontWeight: 700, opacity: 0.8 }}>
                    {row.label}
                  </td>
