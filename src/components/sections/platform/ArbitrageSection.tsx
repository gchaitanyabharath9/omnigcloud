  ...
  return (
    <section id="arbitrage" className="snap-section container" style={{ padding: "8rem 0" }}>
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <h2 className="mb-6 leading-tight max-w-3xl">{t("title")}</h2>
        <p className="text-lead max-w-2xl opacity-70">{t("subtitle")}</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div className="space-y-8">
          <div
            className="glass-panel p-8 group hover:border-primary transition-all duration-500"
            style={{ borderRadius: "2rem", background: "rgba(255,255,255,0.02)" }}
          >
            <div className="flex gap-4 mb-6">
              ...
              <div>
                ...
                <p className="opacity-60 text-sm">{t("forecastDesc")}</p>
              </div>
            </div>
            <BillingForecast />
          </div>
        ...
        <div className="space-y-8 lg:sticky lg:top-24">
          ...
          >
            <div className="flex gap-4 mb-6">
              ...
              <div>
                ...
                <p className="opacity-60 text-sm">{t("switchDesc")}</p>
              </div>
            </div>
            <CloudSwitchSim />
          </div>
          ...
          <div className="p-8 rounded-[2rem] bg-gradient-to-br from-primary/10 to-transparent border border-primary/20">
            ...
            <p className="text-sm opacity-80 leading-relaxed mb-6">{t("eb1aDesc")}</p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center font-mono text-xs border border-white/20">
                JS
              </div>
              <div>
