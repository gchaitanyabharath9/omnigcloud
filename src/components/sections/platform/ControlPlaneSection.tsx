          ...
          <div className="grid-2x2-strict gap-6">
            ...
            <div className="img-card-container h-64 col-span-2 lg:col-span-1">
              <img
                ...
                alt="Control Plane Analytics"
                className="img-cover opacity-80"
              />
              <div
                className="card-overlay"
                style={{
                  background: "linear-gradient(0deg, rgba(2,6,23,0.9) 30%, transparent 100%)",
                }}
              ></div>
            ...
            <div className="col-span-2 lg:col-span-1 grid grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  title: t("gitops"),
                  img: "https://images.unsplash.com/photo-1607799275518-d58665d096c2?w=400&q=80",
                },
                {
