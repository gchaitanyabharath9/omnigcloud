                        ...
                        <div className="glass-panel p-12 rounded-[3rem] border-primary/20 bg-primary/5 relative z-10">
                            <div className="grid grid-cols-2 gap-8">
                                {[
                                    ...
                                    <div key={i}>
                                        <div className="text-4xl font-black text-white mb-2">{tTrust(`stats.${stat.key}_val`)}</div>
                                        <div className="text-sm font-bold uppercase tracking-widest text-primary">{tTrust(`stats.${stat.key}`)}</div>
                                    </div>
                                ))}
                            </div>
