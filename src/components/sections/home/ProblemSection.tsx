...
export default function ProblemSection() {
    return (
        <section className="snap-section" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', position: 'relative', paddingTop: '4.5rem', paddingBottom: '1rem', scrollMarginTop: '0' }}>
