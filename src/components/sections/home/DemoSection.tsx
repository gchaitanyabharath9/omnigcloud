        ...
        <div className="grid-2 gap-6">
          ...
          <div className="card-feature">
            ...
            <div>
              ...
              <p className="card-body text-base">{t("discovery.desc")}</p>
            </div>
            <div
              className="mt-auto pt-4 border-t border-white-05 text-mono text-tiny"
          ...
          <div className="card-feature">
            ...
            <div>
              ...
              <p className="card-body text-base">{t("iac.desc")}</p>
            </div>
            <div
              className="mt-auto pt-4 border-t border-white-05 text-mono text-tiny"
              style={{ borderTop: "1px solid rgba(255,255,255,0.05)", color: "#8b5cf6" }}
            >
              {t("iac.code")}
            </div>
          </div>
          ...
          <div className="card-feature">
            ...
            <div>
              ...
              <p className="card-body text-base">{t("sync.desc")}</p>
            </div>
            <div
              className="mt-auto pt-4 border-t border-white-05 text-mono text-tiny"
              style={{ borderTop: "1px solid rgba(255,255,255,0.05)", color: "#10b981" }}
            >
              {t("sync.code")}
            </div>
          </div>
          ...
          <div className="card-feature">
            ...
            <div>
              ...
              <p className="card-body text-base">{t("drift.desc")}</p>
            </div>
            <div
              className="mt-auto pt-4 border-t border-white-05 text-mono text-tiny"
              style={{ borderTop: "1px solid rgba(255,255,255,0.05)", color: "#ef4444" }}
            >
              {t("drift.code")}
            </div>
          </div>
