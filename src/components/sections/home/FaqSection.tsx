...
export default function FaqSection() {
  ...
  return (
    <section
      className="py-24"
      style={{ background: "var(--bg-surface-2)", borderTop: "1px solid var(--card-border)" }}
    >
      <div className="container" style={{ maxWidth: "900px" }}>
          ...
          {faqs.map((i) => (
            <div
              ...
              style={{
                border: "1px solid var(--card-border)",
                overflow: "hidden",
                background: openIndex === i ? "rgba(59, 130, 246, 0.05)" : "rgba(255,255,255,0.02)",
              }}
            >
              <button
        ...
        <div style={{ marginTop: "4rem", textAlign: "center" }}>
          ...
          <Link href="/contact" className="btn-secondary" style={{ padding: "0.75rem 2rem" }}>
            {t("footer.cta")}
          </Link>
        </div>
      </div>
