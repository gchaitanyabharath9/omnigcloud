    ...
    >
      ...
      <div className="container relative z-10">
        <div className="text-center mb-20">
          ...
          <p
            className="text-muted-foreground mx-auto font-medium leading-relaxed"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((industry, i) => (
            <div
              key={i}
              className="glass-panel group p-8 rounded-2xl flex flex-col border-white/5 bg-white/[0.02] hover:border-primary/40 hover:bg-white/[0.05] transition-all duration-500 hover:-translate-y-2"
            >
