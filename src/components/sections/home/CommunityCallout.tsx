...
export default function CommunityCallout() {
  ...
  return (
    <section
      ...
      style={{ background: "var(--bg-surface-2)", paddingTop: "1rem", paddingBottom: "1rem" }}
    >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "0.75rem" }}>
              {[
                ...
                <div
                  ...
                  style={{ padding: "0.75rem", borderRadius: "0.75rem", textAlign: "center" }}
                >
                  <stat.icon size={16} color={stat.color} style={{ margin: "0 auto 0.25rem" }} />
                  <div style={{ fontSize: "1.25rem", fontWeight: 950, color: "var(--primary)" }}>
                    {stat.val}
                  </div>
                ...
                {[
                  {
                    icon: Terminal,
                    title: t("cli.badge"),
                    desc: t("cli.description").substring(0, 30) + "...",
                  ...
                  },
                  {
                    icon: Code,
                    title: t("hero.plugin"),
                    desc: "Extensible core",
                    bg: "rgba(16, 185, 129, 0.1)",
                    color: "#10b981",
                  },
                  {
                    icon: Users,
                    title: t("network.advisory.name"),
