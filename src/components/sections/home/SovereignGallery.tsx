    ...
    <>
      {items.map((item, idx) => (
        <section
          ...
          style={{ background: idx % 2 === 0 ? "var(--background)" : "var(--bg-surface-2)" }}
        >
          <div className="container">
            {idx === 0 && (
              <div style={{ textAlign: "center", marginBottom: "4rem" }}>
                <h2 style={{ fontSize: "var(--h2-size)", fontWeight: 950, marginBottom: "1rem" }}>
                  {t("title")}
                </h2>
                <p
                  style={{
            ...
            >
              <div style={{ order: idx % 2 === 0 ? 1 : 2 }}>
                <h3 style={{ fontSize: "var(--h3-size)", fontWeight: 900, marginBottom: "1.5rem" }}>
                  {t(`${item.id}.title`)}
                </h3>
                <p
                  style={{
