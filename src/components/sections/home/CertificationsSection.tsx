        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "4rem" }}>
          ...
          >
            {certs.map((cert, i) => (
              <div
                key={i}
                className="glass-panel group p-8 hover:border-primary/40 transition-all duration-500 border-white/5 bg-white/[0.02]"
              ...
              >
                ...
                <div className="text-base font-black text-foreground mb-1 tracking-tight group-hover:text-primary transition-colors">
                  {cert.name}
                </div>
