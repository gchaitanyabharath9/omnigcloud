...
export default function EcosystemSection() {
    ...
    return (
        <section id="ecosystem" className="snap-section" style={{ background: 'var(--background)', minHeight: '100vh', display: 'flex', alignItems: 'flex-start', paddingTop: '4.5rem', paddingBottom: '0.5rem', position: 'relative' }}>
