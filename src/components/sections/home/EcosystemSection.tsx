    ...
    >
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        ...
        >
          ...
          <h2 className="mb-1" style={{ fontSize: "clamp(1.8rem, 4vw, 2.2rem)", fontWeight: 900 }}>
            {t("title")}
          </h2>
          <p
            className="text-section-lead"
            style={{ maxWidth: "800px", fontSize: "0.9rem", marginBottom: "0.5rem" }}
          >
            {t("subtitle")}
          </p>
        </div>
        ...
        <div className="grid-2x2-strict" style={{ gap: "0.75rem", marginBottom: "3rem" }}>
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: "1.5rem", fontWeight: 900, opacity: 0.05, lineHeight: 0.8 }}>
                01
              </div>
            </div>
        ...
        <div style={{ marginBottom: "3rem" }}>
          ...
          <div className="glass-panel" style={{ padding: "2rem", borderRadius: "1.5rem" }}>
            ...
            >
              {["aws", "azure", "gcp", "oracle", "hashicorp", "redhat", "vmware", "cisco"].map(
                (partnerKey) => (
                  <div
                    key={partnerKey}
                    style={{
