        ...
        <Container>
          ...
          <div className="mb-12">
            <div className="text-center mb-8">
              ...
              <h2 className="text-[length:var(--h2-size)] font-black mb-2">{t("realResults")}</h2>
              <p className="opacity-70 max-w-[700px] mx-auto text-[0.95rem]">{t("metricsDesc")}</p>
            </div>
          ...
          <div className="card-cta mt-24">
            ...
            <p className="text-section-lead mb-6">{t("subtitle")}</p>
