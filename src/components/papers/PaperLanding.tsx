            ...
            <main className="container mx-auto px-4 py-20">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <article className="lg:col-span-8">
                        ...
                        <section className="mb-12">
                            <h3 className="text-lg font-bold text-white mb-4">{tPapers('Common.keywordsHeading')}</h3>
                            <div className="flex flex-wrap gap-2">
                                {tPapers(getLocalKey(paper.keywordsKey)).split(',').map((kw, i) => (
                                    <span key={i} className="px-3 py-1 bg-white/5 rounded-full text-xs font-mono text-primary border border-white/5">
                                        {kw.trim()}
                                    </span>
                                ))}
                            </div>
