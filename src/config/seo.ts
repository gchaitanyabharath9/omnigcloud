...
export const seoConfig = {
    ...
    defaultDescription: 'Leading research in cloud-native architecture, distributed systems, and enterprise governance. Explore our peer-reviewed papers on microservices, scalability, and platform engineering.',

    // Research Papers - Optimized for Academic Search
    researchPapers: {
        a1: {
            title: 'Cloud-Native Enterprise Reference Architecture | OmniGCloud Research',
            description: 'Comprehensive reference architecture for cloud-native enterprise systems. Learn about plane separation, cellular architecture, and governance patterns for 99.99% availability at scale.',
            keywords: [
        ...
        a2: {
            ...
            description: 'Achieve 250,000+ RPS with linear scalability. Research on Universal Scalability Law, async partitioning, and capacity planning for distributed systems.',
            keywords: [
                'distributed systems',
        ...
        a3: {
            ...
            description: 'Advanced observability patterns for enterprise systems. Cardinality management, SLO definitions, and operational intelligence frameworks.',
            keywords: [
                'observability',
        ...
        a4: {
            ...
            description: 'Policy-as-code, compliance automation, and governance frameworks for multi-cloud and hybrid cloud environments.',
            keywords: [
                'platform governance',
                'multi-cloud',
                'hybrid cloud',
        ...
        a5: {
            ...
            description: 'Proven patterns for modernizing monolithic applications. Strangler Fig pattern, data migration lifecycle, and anti-corruption layers.',
            keywords: [
                'cloud migration',
                'modernization',
        ...
        a6: {
            ...
            description: 'Dynamic policy enforcement, threat response lifecycle, and adaptive security patterns for cloud-native systems.',
            keywords: [
                'policy enforcement',
                'adaptive security',
        ...
        scholarly: {
            ...
            description: 'Peer-reviewed research on the fundamental tension in enterprise cloud-native architectures. Quantified failure modes and architectural solutions.',
            keywords: [
                'enterprise architecture',
                'cloud native',
