...
export const PUBLIC_ROUTES_MANIFEST: RouteEntry[] = [
    ...
    // Research Papers
    { path: '/research/papers/a1-cloud-native-enterprise-reference', priority: 0.8, changeFreq: 'monthly' },
    { path: '/research/papers/a2-high-throughput-distributed-systems', priority: 0.8, changeFreq: 'monthly' },
    { path: '/research/papers/a3-enterprise-observability-operational-intelligence', priority: 0.8, changeFreq: 'monthly' },
    { path: '/research/papers/a4-platform-governance-multicloud-hybrid', priority: 0.8, changeFreq: 'monthly' },
    { path: '/research/papers/a5-monolith-to-cloud-native-modernization', priority: 0.8, changeFreq: 'monthly' },
    ...
    { path: '/research/automated-multilingual-quality-assurance', priority: 0.8, changeFreq: 'monthly' },
