...
export const SEO_KEYWORDS = {
  platform: [
    "sovereign multi-cloud platform",
    "cloud agnostic discovery",
    "AECP engine",
    "enterprise cloud kernel",
    "autonomous governance hub",
    "cross-cloud mesh",
    "digital sovereignty",
  ...
  ai: [
    ...
    "AI-native cloud foundation",
    "predictive infra analytics",
    "neural cloud orchestration",
    "generative AI sovereignty",
  ],
};
