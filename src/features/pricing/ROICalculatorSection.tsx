                ...
                <div className="grid-2x2-strict" style={{ gap: '1.5rem', gridTemplateRows: 'repeat(2, minmax(300px, auto))' }}>
                    ...
                    <div className="glass-panel" style={{ padding: '2rem', borderRadius: '1.5rem', display: 'flex', flexDirection: 'column' }}>
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 900 }}>{t('metrics.averageROI.title')}</h3>
                                <p style={{ fontSize: '0.75rem', opacity: 0.5, margin: 0 }}>{t('metrics.averageROI.subtitle')}</p>
                            </div>
                    ...
                    <div className="glass-panel" style={{ padding: '2rem', borderRadius: '1.5rem', display: 'flex', flexDirection: 'column' }}>
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 900 }}>{t('metrics.costReduction.title')}</h3>
                                <p style={{ fontSize: '0.75rem', opacity: 0.5, margin: 0 }}>{t('metrics.costReduction.subtitle')}</p>
                            </div>
                    ...
                    <div className="glass-panel" style={{ padding: '2rem', borderRadius: '1.5rem', display: 'flex', flexDirection: 'column', gridColumn: '1 / -1' }}>
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 900 }}>{t('metrics.comparison.title')}</h3>
                                <p style={{ fontSize: '0.75rem', opacity: 0.5, margin: 0 }}>{t('metrics.comparison.subtitle')}</p>
                            </div>
