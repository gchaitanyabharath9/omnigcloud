      ...
      <PageShell>
        ...
        <div className="grid grid-cols-1 gap-4 max-w-4xl">
          {steps.map((i) => (
            <div
              key={i}
              className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:border-primary/30 transition-all duration-300"
            >
              <div className="relative z-10 flex flex-col gap-4 pb-2 text-left">
