        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          <div>
            ...
            <p
              ...
              style={{ fontSize: "1.2rem", maxWidth: "90%", lineHeight: 1.6, opacity: 0.9 }}
            >
              {description}
            </p>
          ...
          >
            ...
            >
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1rem" }}>
                {[
                  { l: t("metrics.assets"), v: "$2.4B" },
                  { l: t("metrics.drift"), v: "0%", c: "#10b981" },
                  { l: t("metrics.nodes"), v: "4k+", c: "var(--primary)" },
                ].map((s, i) => (
                  <div
                    key={i}
                    style={{
                  ...
                  >
                    ...
                    <div style={{ fontSize: "1.25rem", fontWeight: 900, color: s.c || "white" }}>
                      {s.v}
                    </div>
                  </div>
                ))}
